...
interface LastUpdatedTextState {
  timeDifferenceInMinutes: number;
  timeDifferenceInHours: number;
}

class LastUpdatedText extends Component<LastUpdatedTextProps, LastUpdatedTextState> {
  interval: NodeJS.Timeout | undefined;

  constructor(props: LastUpdatedTextProps) {
    super(props);
  ...
  componentWillReceiveProps(nextProps: LastUpdatedTextProps) {
